...
compatibility: Uses git and the project-local libmcp-project MCP server when available.
metadata:
  project: libmcp
  scope: review
---
...
1. Read root `AGENTS.md` and call `git_status` through `libmcp-project` MCP.
